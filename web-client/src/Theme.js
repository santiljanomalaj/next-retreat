...
export const COLORS = {
  ...
  DEEP_BLUE: '#230F4E' /* Deep Dark Blue */,
...
export const GRADIENTS = {
  TAG: `180deg, ${COLORS.IRRADIANT_IRIS} 0%, rgba(219, 223, 231, 0.765625) 95.64%, #BEC5D1 97.54%`,
  RATING: `180deg, ${COLORS.SPACE_CADET} 0%, #2F4B7B 100%`,
  BUTTON_HOVER:
